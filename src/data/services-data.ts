...
export const servicesData: ServiceData[] = [
  {
    ...
    portfolio: [
      { src: "/images/maconnerie-neuve.jpg",       alt: "Construction murs porteurs briques", caption: "Murs porteurs — briques de parement Vandersanden" },
      { src: "/images/fondations-beton.jpg",        alt: "Fondations béton armé",              caption: "Fondations — béton armé C30/37" },
      { src: "/images/cloisons-parpaings.jpg",      alt: "Cloisons parpaings",                 caption: "Cloisons — blocs Ytong 15 cm" },
    ],
  ...
  },
  {
    ...
    portfolio: [
      { src: "/images/renovation-facade.jpg",     alt: "Ravalement façade briques",       caption: "Ravalement — briques de Boom, rejointoiement NHL" },
      { src: "/images/fissures-reparation.jpg",   alt: "Réparation fissures façade",       caption: "Fissures actives — agrafage et injection résine" },
      { src: "/images/restauration-patrimoine.jpg", alt: "Restauration façade Art Nouveau", caption: "Restauration Art Nouveau — chaux naturelle" },
    ],
  ...
  },
  {
    ...
    portfolio: [
      { src: "/images/facades-ite.jpg",      alt: "Isolation thermique par l'extérieur", caption: "ITE — panneaux EPS 14 cm, R = 4,9 m²K/W" },
      { src: "/images/crepis-finition.jpg",  alt: "Crépis et enduits de finition",       caption: "Enduit minéral — texture grésée, teinte RAL" },
      { src: "/images/facades-avant-apres.jpg", alt: "Façade avant/après isolation",     caption: "Avant/après — ITE + crépis, gain PEB A" },
    ],
  ...
  },
  {
    ...
    portfolio: [
      { src: "/images/terrasse-gres.jpg",      alt: "Terrasse grès cérame extérieur",      caption: "Terrasse — grès cérame 60x60, R11 anti-dérapant" },
      { src: "/images/allee-porphyre.jpg",     alt: "Allée pavés porphyre belge",          caption: "Allée — porphyre belge de Lessines, joint sable" },
      { src: "/images/beton-desactive.jpg",    alt: "Béton désactivé allée de garage",     caption: "Allée garage — béton désactivé granit blanc" },
    ],
