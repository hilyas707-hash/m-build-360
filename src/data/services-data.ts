...
export const servicesData: ServiceData[] = [
  {
    ...
    portfolio: [
      { src: "https://images.unsplash.com/photo-1590069261209-f8e9b8642343?auto=format&fit=crop&w=900&q=80", alt: "Construction murs porteurs briques", caption: "Murs porteurs — briques de parement Vandersanden" },
      { src: "https://images.unsplash.com/photo-1504307651254-35680f356dfd?auto=format&fit=crop&w=900&q=80", alt: "Fondations béton armé",              caption: "Fondations — béton armé C30/37" },
      { src: "https://images.unsplash.com/photo-1565008447742-97f6f38c985c?auto=format&fit=crop&w=900&q=80", alt: "Cloisons parpaings",                 caption: "Cloisons — blocs Ytong 15 cm" },
    ],
  ...
  },
  {
    ...
    portfolio: [
      { src: "https://images.unsplash.com/photo-1542621334-a254cf47733d?auto=format&fit=crop&w=900&q=80", alt: "Ravalement façade briques",       caption: "Ravalement — briques de Boom, rejointoiement NHL" },
      { src: "https://images.unsplash.com/photo-1503708928676-1cb796a0891e?auto=format&fit=crop&w=900&q=80", alt: "Réparation fissures façade",       caption: "Fissures actives — agrafage et injection résine" },
      { src: "https://images.unsplash.com/photo-1520516797786-7b5b6a47b32b?auto=format&fit=crop&w=900&q=80", alt: "Restauration façade Art Nouveau", caption: "Restauration Art Nouveau — chaux naturelle" },
    ],
  ...
  },
  {
    ...
    portfolio: [
      { src: "https://images.unsplash.com/photo-1564182842519-8a3b2af3e228?auto=format&fit=crop&w=900&q=80", alt: "Isolation thermique par l'extérieur", caption: "ITE — panneaux EPS 14 cm, R = 4,9 m²K/W" },
      { src: "https://images.unsplash.com/photo-1487958449943-2429e8be8625?auto=format&fit=crop&w=900&q=80", alt: "Crépis et enduits de finition",       caption: "Enduit minéral — texture grésée, teinte RAL" },
      { src: "https://images.unsplash.com/photo-1449844908441-8829872d2607?auto=format&fit=crop&w=900&q=80", alt: "Façade avant/après isolation",     caption: "Avant/après — ITE + crépis, gain PEB A" },
    ],
  ...
  },
  {
    ...
    portfolio: [
      { src: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?auto=format&fit=crop&w=900&q=80", alt: "Terrasse grès cérame extérieur",      caption: "Terrasse — grès cérame 60x60, R11 anti-dérapant" },
      { src: "https://images.unsplash.com/photo-1586773860418-d37222d8fce3?auto=format&fit=crop&w=900&q=80", alt: "Allée pavés porphyre belge",          caption: "Allée — porphyre belge de Lessines, joint sable" },
      { src: "https://images.unsplash.com/photo-1501854140801-50d01698950b?auto=format&fit=crop&w=900&q=80", alt: "Béton désactivé allée de garage",     caption: "Allée garage — béton désactivé granit blanc" },
    ],
